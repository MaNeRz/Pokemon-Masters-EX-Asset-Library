...
- Release: [v1.3.0](https://github.com/MaNeRz/Pokemon-Masters-EX-Asset-Library/releases/tag/v1.3.0)
- Game data: `2.72`
...
The **19,680** standalone UI canonical assets and **1,300** derived Generated Sync Pair assets are tracked with Git LFS.
...
- `Pokemon-Masters-EX-Asset-Library-v1.3.0-Items-Atlas.zip`
- `Pokemon-Masters-EX-Asset-Library-v1.3.0-Standalone-UI.zip`
- `Pokemon-Masters-EX-Asset-Library-v1.3.0-Generated-Sync-Pair.zip`
